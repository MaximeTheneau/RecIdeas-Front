  ...
  return (
    <section className="p-4  my-4">
      <div className="flex flex-wrap justify-center gap-8">
        {atouts.map((atout) => (
          <div key={atout.title} className="bg-white shadow-lg p-6 hover:bg-secondaryLight rounded-lg  w-60">
