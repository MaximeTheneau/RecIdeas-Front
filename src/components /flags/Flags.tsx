...
type FlagKey = 'en' | 'fr' | 'es' | 'de' | 'it';

function Flags({ language }: { language: FlagKey }) {
  const flags: { [key in FlagKey]: JSX.Element } = {
    en: (
      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 32 32">
        <title id="title">Flag England</title>
    ...
    fr: (
      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 640 480">
        <title id="title">Drapeau Français</title>
    ...
    es: (
      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 32 32">
        <title id="title">bandera de españa</title>
        ...
        <path d="M12.531,14.533h-4.28l.003,2.572v1.485c0,.432,.226,.822,.591,1.019,.473,.252,1.024,.391,1.552,.391s1.064-.135,1.544-.391c.364-.197,.591-.587,.591-1.019v-4.057Z" fill="#a0251e" />
      </svg>
    ),
    de: (
      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 32 32">
        <title id="title">Flagge Deutch</title>
    ...
    it: (
      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 32 32">
        <title id="title">Bandiera italia</title>
        <path fill="#fff" d="M10 4H22V28H10z" />
        <path d="M5,4h6V28H5c-2.208,0-4-1.792-4-4V8c0-2.208,1.792-4,4-4Z" fill="#41914d" />
        <path d="M25,4h6V28h-6c-2.208,0-4-1.792-4-4V8c0-2.208,1.792-4,4-4Z" transform="rotate(180 26 16)" fill="#bf393b" />
        <path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15" />
        <path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2" />
      </svg>
    ),
